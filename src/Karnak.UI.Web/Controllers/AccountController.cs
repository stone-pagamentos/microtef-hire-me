...
using Karnak.Infra.CrossCutting.Identity.Extensions;
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // User claim for write cardbrands data
                    await _userManager.AddClaimAsync(user, new Claim("CardBrand", "Write"));
                    await _userManager.AddClaimAsync(user, new Claim("CardBrand", "Remove"));
